...
def main():
	...
	for id in range(9, 13):
		filename_genelist = "/work/PCDC/s182862/data/heart/geneList_" + str(id) + ".out"
		...
		for isrc in range(start_point[rank], start_point[rank + 1]):
			...
			filename = gene + ".csv"
			folderpath = "/work/PCDC/s182862/data/heart/heart" + str(id) + "/"
			...
			filename = gene + ".csv"
			filepath = "/work/PCDC/s182862/data/heart/heart_out_lfft2_" + str(id) + "/"
